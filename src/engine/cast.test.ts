...
test("castPlay: stub stream refreshes one progress line and preserves every raw transcript message (T-072-02-02 AC)", async () => {
  ...
  expect(live).toBe(
    "\r\x1b[2Kelapsed 12s · 0/1000k weighted tokens · turn 0" +
      "\r\x1b[2Kelapsed 34s · 7/1000k weighted tokens · turn 1" +
      "\r\x1b[2Kelapsed 56s · 22/1000k weighted tokens · turn 1\n",
  );
  expect(live.match(/\n/g)).toHaveLength(1);
